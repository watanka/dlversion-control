...
def add_project(db : Session, project_name : str, description : Optional[str] = None, commit : bool = True) -> schemas.Project :
...
def select_experiment_by_project_id(db : Session, model_id : str) -> List[schemas.Experiment] :
    return db.query(models.Experiment, models.Model) \
